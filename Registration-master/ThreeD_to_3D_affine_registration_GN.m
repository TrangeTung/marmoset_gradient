function [A,fAI] = ThreeD_to_3D_affine_registration_GN(xI,yI,zI,I,xJ,yJ,zJ,J,A0,downs,niter,e)
...
for downloop = 1 : length(downs)
    ...
    I = imresize3(I0,size(I0)/down);
    xI=xI0(1:down:end);yI=yI0(1:down:end);zI=zI0(1:down:end);
    ...
    J = imresize3(J0,size(J0)/down);
    xJ=xJ0(1:down:end);yJ=yJ0(1:down:end);zJ=zJ0(1:down:end);
